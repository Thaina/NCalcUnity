...
namespace NCalc.Domain
{
	...
	/// <summary>
		...
		public override void Visit(TernaryExpression expression)
		{
			...
			var resultExpression = Convert.ToBoolean(Result) ? expression.MiddleExpression : expression.RightExpression;
		...
		public override void Visit(BinaryExpression expression)
		{
			...
			switch (expression.Type)
			{
				...
				case BinaryExpressionType.Minus:
					Result = Checked ? Numbers.SoustractChecked(left(), right(), _options) : Numbers.Soustract(left(), right(), _options);
					break;
		...
		{
			if (Parameters.TryGetValue(parameter.Name,out var obj) && obj != null)
			{
